...
if [[ "$CONFIGURATION" == "Debug-Development" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_sound_record/flutter_sound_record.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/insta_assets_crop/insta_assets_crop.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/sms_autodetect/sms_autodetect.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/sms_autofill/sms_autofill.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/social_share/social_share.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ua_client_hints/ua_client_hints.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg-kit-ios-https/ffmpegkit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg-kit-ios-https/libavcodec.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg-kit-ios-https/libavdevice.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg-kit-ios-https/libavfilter.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg-kit-ios-https/libavformat.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg-kit-ios-https/libavutil.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg-kit-ios-https/libswresample.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg-kit-ios-https/libswscale.framework"
fi
