  ...
  Future<dynamic> createCommentOrReplyLike(Map<String, dynamic> data) async {
    ...
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'EventComment/CreateCommentOrReplyLike',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<dynamic> removeCommentOrReplyLike(Map<String, dynamic> data) async {
    ...
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'EventComment/RemoveCommentOrReplyLike',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<dynamic> updateCommentPrivacy(Map<String, dynamic> data) async {
    ...
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'EventComment/UpdateCommentPrivacy',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
