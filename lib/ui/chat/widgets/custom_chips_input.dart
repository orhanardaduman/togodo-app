...
/// The [CustomChipsInput] widget is a text field that allows the user to input and create chips out of it.
class CustomChipsInput extends StatefulWidget {
  /// Creates a [CustomChipsInput] widget.
  ///
  ...
  @override
  State<CustomChipsInput> createState() => CustomChipsInputState();
}

class CustomChipsInputState extends State<CustomChipsInput> {
  ...
  List<Widget> _buildChipsSection() {
    final chips = <Widget>[];
    for (var i = 0; i < widget.chipsText.length; i++) {
      chips.add(
        Container(
              ...
              RawKeyboardListener(
                ...
                onKey: (event) {
                  ...
                  if (event.data.logicalKey.keyLabel == widget.eraseKeyLabel) {
                    if (_controller.text.isEmpty &&
                      ...
                      setState(() {
                        widget.onChipDeleted?.call(
                          widget.chipsText.last,
                          widget.chipsText.length - 1,
                        );
                ...
                child: TextFormField(
                  ...
                  onFieldSubmitted: (value) {
                    _output = '';
                    for (final text in widget.chipsText) {
