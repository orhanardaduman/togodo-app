...
import 'package:togodo/ui/chat/widgets/voice_message/helpers/play_status.dart';
import 'package:togodo/ui/chat/widgets/voice_message/helpers/utils.dart';
import 'package:togodo/ui/chat/widgets/voice_message/voice_controller.dart';
import 'package:togodo/ui/chat/widgets/voice_message/widgets/noises.dart';
import 'package:togodo/ui/chat/widgets/voice_message/widgets/play_pause_button.dart';

/// A widget that displays a voice message view with play/pause functionality.
///
/// The [CustomVoiceMessageView] widget is used to display a voice message with customizable appearance and behavior.
...
///
class CustomVoiceMessageView extends StatelessWidget {
  const CustomVoiceMessageView({
  ...
  SizedBox _noises(ThemeData newTHeme) => SizedBox(
        height: 30,
        width: controller.noiseWidth - 50,
        child: Stack(
