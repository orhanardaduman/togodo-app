...
class VoiceController extends MyTicker {
  ...
  ValueNotifier<dynamic> updater = ValueNotifier(null);
  List<double>? randoms;
  StreamSubscription<dynamic>? positionStream;
  StreamSubscription<dynamic>? playerStateStream;
  ...
  Future<dynamic> stopPlaying() async {
    await _player.pause();
    playStatus = PlayStatus.stop;
  }

  /// Starts playing the voice.
  Future<dynamic> startPlaying(String path) async {
  ...
  Future<dynamic> setMaxDuration(String path) async {
    try {
