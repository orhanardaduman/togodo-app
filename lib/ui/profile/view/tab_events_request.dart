...
import 'package:togodo/ui/profile/view_model/tab_event_request_view_model.dart';
import 'package:togodo/ui/profile/widget/null_event.dart';

class TabEventsRequestView extends StatefulHookConsumerWidget {
  const TabEventsRequestView({
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _TabEventsRequestViewState();
}

class _TabEventsRequestViewState extends ConsumerState<TabEventsRequestView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref
          .read(tabEventsRequestViewModelProvider(widget.userId).notifier)
          .fetchEvents();
    });
  }
  ...
  Widget build(BuildContext context) {
    final data = ref.watch(tabEventsRequestViewModelProvider(widget.userId));
    final notifier =
        ref.watch(tabEventsRequestViewModelProvider(widget.userId).notifier);
