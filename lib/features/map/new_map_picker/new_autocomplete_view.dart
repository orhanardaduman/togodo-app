// ignore_for_file: comment_references, deprecated_member_use_from_same_package
...
class NewPlacesAutocomplete extends HookConsumerWidget {
  const NewPlacesAutocomplete({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        decoration: theme.mode == ThemeMode.dark
            ? const BoxDecoration().addCustomShadow(
                color: MainColors.shadowText.withOpacity(0.69),
                offsetX: 4,
                offsetY: 16,
                blurRadius: 32,
              )
            : const BoxDecoration().addCustomShadow(
                color: MainColors.white.withOpacity(0.69),
                offsetX: 4,
                offsetY: 16,
                blurRadius: 32,
              ),
